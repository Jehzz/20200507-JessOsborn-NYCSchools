...
public class MainActivity extends AppCompatActivity implements ShowAllDataInterface {
    ...
    protected void onCreate(Bundle savedInstanceState) {
        ...
        schoolViewModel.getListOfSchools().observe(this, listOfSchools -> {
            schoolAdapter.setDataSet(listOfSchools);
            setSearchListener();
        });

        //Observe ViewModel error message, which will trigger a Toast to notify the user
        schoolViewModel.getError().observe(this, errorMessage -> Toast.makeText(this, "Error: " + errorMessage, Toast.LENGTH_SHORT).show());
    }
    ...
    public void onClick(SchoolSATData school) {
        ...
        fragmentTransaction.setCustomAnimations(R.anim.fragment_anim_slide_down, R.anim.fragment_anim_slide_up, R.anim.fragment_anim_slide_down, R.anim.fragment_anim_slide_up);
